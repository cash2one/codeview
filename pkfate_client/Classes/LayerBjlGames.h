...
class BJLRoomItem :public Widget
{
private:
	Node *rootNode;
	
	void btnClickHandler(Ref * sender);
	RoomInfoBjl* roomInfoBjl;
	void enterRoom();
public:
	spRoomInfo* sp;

	void setProperty(RoomInfoBjl* roomInfoBjl);
	CREATE_FUNC(BJLRoomItem);
...
class LayerBjlGames : public Layer,protected GuideHandler
{
protected:
	Node *RootNode;
