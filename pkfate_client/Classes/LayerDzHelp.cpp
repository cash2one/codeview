...
bool LayerDzHelp::init()
{
	...
	/*	载入cocos studio 资源
	*/
	Node* _nodeRoot = CSLoader::createNode("dz/LayerDzHelp.csb");
	if (!_nodeRoot)
		return false;
	...
	btnOpt_guidePageView->addEventListenerPageView(this, pagevieweventselector(LayerDzHelp::btnOpt_pageViewEvent));
	...
	btnRule_guidePageView->addEventListenerPageView(this, pagevieweventselector(LayerDzHelp::btnRule_pageViewEvent));
	...
	listener->onTouchBegan = CC_CALLBACK_2(LayerDzHelp::onTouchBegan, this);
...
void LayerDzHelp::chooseOptPanel(bool isOpt)
{
...
void LayerDzHelp::selectOptPointIndex(unsigned short index)
{
...
void LayerDzHelp::selectRulePointIndex(unsigned short index)
{
...
void LayerDzHelp::btnOpt_pageViewEvent(cocos2d::Ref *pSender, PageViewEventType type)
{
	switch (type) 
	{
...
void LayerDzHelp::btnRule_pageViewEvent(cocos2d::Ref *pSender, PageViewEventType type)
{
	switch (type)
	{
	case cocos2d::ui::PAGEVIEW_EVENT_TURNING:
...
bool LayerDzHelp::onTouchBegan(Touch *touch, Event *event){
