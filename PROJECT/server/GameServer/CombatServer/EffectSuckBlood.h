...
#ifndef __COMBATSERVER_EFFECTSUCKBLOOD_H__
#define __COMBATSERVER_EFFECTSUCKBLOOD_H__


#include "Effect.h"
#include "IEventServer.h"

class EffectSuckBlood : public Effect,public IActionListener
{
public:
	EffectSuckBlood();
	virtual ~EffectSuckBlood();
